...
//	}
//
//	g := gcache.GetGroup[string, []byte](groupName)
//	if g == nil {
...
//func (s *Server[K, V]) AddPeers(peersAddr ...string) {
//	s.mu.Lock()
//	defer s.mu.Unlock()
//
...
//	}
//}
//func (s *Server[K, V]) DelPeers(peersAddr ...string) {
//	s.mu.Lock()
//	defer s.mu.Unlock()
//
...
//func (s *Server[K, V]) Pick(key string) (peer.Fetcher, bool) {
//	s.mu.Lock()
//	defer s.mu.Unlock()
//
